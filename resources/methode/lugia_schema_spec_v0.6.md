...
**Version** 0.6 — Santé fonctionnelle (workarounds & complétude fonctionnelle)  
**Projet** Lugia Checkup  
**Auteur** Sébastien / Lugia  
**Date** Juin 2026 — Arbitrages du 03/06/2026 · Temporalité v0.3 · Inter-systèmes v0.4 · Santé fonctionnelle v0.6

> **v0.6 — Trois ajouts issus du corpus Steven Alter** (arbitrage « justesse sans complexité ») :
...
13. [Les 10 axes organisationnels](#13-les-10-axes-organisationnels)
...
Extraction automatique d'objets typés
        ↓
Construction de la grille (10 axes × 9 lentilles WSF)
        ↓
...
- **Les 10 axes organisationnels** (taxonomie Lugia) : la fonction de chaque objet — à quoi il *contribue*
...
Les 10 axes sont la structure organisationnelle de premier niveau. Ils sont **fixes** dans le schéma générique mais peuvent être **renommés et réordonnés** par secteur.
...
### Les 10 axes — valeurs par défaut
...
| `developpement_commercial` | Développement commercial | Développement & patientèle | Comment l'activité se développe — réputation, fidélisation, partenariats, acquisition de bénéficiaires *(optionnel par secteur)* |
| `rd_innovation` | R&D & Innovation | Innovation de pratique | Comment l'organisation invente son futur — veille, expérimentation, innovation organisationnelle *(optionnel par secteur)* |

> **Axes 9 et 10 = optionnels par secteur.** Chaque instanciation sectorielle déclare si les axes Développement commercial et R&D & Innovation sont actifs (professions réglementées sans prospection, petites structures sans R&D formelle). Aucun seuil ni règle n'est indexé sur le nombre d'axes.
...
## 13. Les 10 axes organisationnels
...
#### Axe 9 — Développement commercial
**Comment l'activité se développe — comment on trouve et convainc de nouveaux bénéficiaires**

- Réputation & présence (visibilité, avis, référencement)
- Fidélisation & récurrence de la relation
- Partenariats commerciaux
- Communication institutionnelle & marque
- *Question clé : Comment trouve-t-on et convainc-t-on de nouveaux bénéficiaires ?*
- **Optionnel par secteur** — les professions réglementées ne « prospectent » pas au sens commercial.

Exemples médecine : présence en ligne du cabinet, avis patients, adressage confrère, intégration MSP/CPTS, communication de prévention

#### Axe 10 — R&D & Innovation
**Comment l'organisation invente son futur**

- Veille & intelligence prospective (veille scientifique & technologique, veille réglementaire prospective, détection des signaux faibles)
- Innovation de pratique & de processus (expérimentation de nouvelles techniques, innovation organisationnelle)
- *Question clé : Crée-t-on de nouvelles connaissances, méthodes ou offres ? Investit-on dans son propre renouvellement ?*
- **Optionnel par secteur** — petites structures sans R&D formelle.

Exemples médecine : intégration de recommandations HAS récentes, télémédecine expérimentale, protocoles de coopération, participation à des études, nouvelles techniques de consultation
...
| Profond | Grille 10×9 complète, relations, graphe de dépendance | Consultant / éditeur |

...
export const nightPalette = {
  ...
  // Et "ivory" est la SURFACE → sombre
  ivory: "#1e2738",
  ivoryLight: "#222d3e",
  ivory2: "#222d3e",
  paper: "#192030", // fond body en mode nuit
...
/* ---------- Couleurs d'axes (radar uniquement) ---------- */
/**
 * Trois couleurs jamais utilisées hors visualisation radar / barres d'axe.
 * La charte questionnaire interdit l'usage des couleurs d'axe pour encoder
 * les blocs ailleurs (« le médecin n'a pas besoin d'apprendre un code couleur »).
 *
 *  - A = Parcours patient (vert profond, calme)
 *  - B = Équipe & secrétariat (bleu profond, stable)
 *  - C = Outils & dossiers (orange brûlé, attention)
 *
 * `g` = fond très dilué pour les zones de polygone radar.
 * `h` = teinte hover/highlight.
 */
export const dayAxes = {
  A: "#2d7a5e",
  Ag: "rgba(45,122,94,0.10)",
  Ah: "#1d5240",
  B: "#2a4fa0",
  Bg: "rgba(42,79,160,0.10)",
  Bh: "#1a3270",
  C: "#b5420a",
  Cg: "rgba(181,66,10,0.09)",
  Ch: "#b5420a",
} as const;

export const nightAxes = {
  A: "#4aab84",
  Ag: "rgba(74,171,132,0.12)",
  Ah: "#7dcfaa",
  B: "#5b82d4",
  Bg: "rgba(91,130,212,0.12)",
  Bh: "#8faee8",
  C: "#e07040",
  Cg: "rgba(224,112,64,0.12)",
  Ch: "#e07040",
} as const;
...
export const daySignalWarn = {
  // Valeur par défaut = modèle cible
  default: "#7a6030",
  surface: "rgba(122,96,48,0.10)", // surface 10 % (charte questionnaire)
  border: "rgba(122,96,48,0.32)", // bordure 32 %
} as const;

export const nightSignalWarn = {
  default: "#c4a055",
  surface: "rgba(196,160,85,0.10)",
  border: "rgba(196,160,85,0.32)",
} as const;
...
/* ---------- Proportions de surface (D-031, arbitrage #2) ---------- */
/**
 * Deux ratios légitimes selon le contexte d'usage. À considérer comme un guide
 * pour la composition de pages, pas comme une règle exacte au pixel près.
 */
export const surfaceRatios = {
  day: {
    ...
    navy: 25,
    argent: 5,
    // autre 5 % (signal-warn, axes, blancs techniques)
  },
  night: {
    navy: 75, // dominante surface sombre
    ivory: 20, // texte clair et accents
    argent: 5,
  },
} as const;

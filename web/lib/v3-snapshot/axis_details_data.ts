...
export const AXIS_DETAILS: AxisDetailsTable = {
  ...
  C: {
    ...
    1: {
      // En transition
      summary:
        "Quelques fonctions utilisées, le reste en sommeil. Le logiciel pourrait porter bien plus qu'aujourd'hui.",
      forces: [
    ...
    3: {
      ...
      marges: [
        { text: "Passer au pilotage par les données (KPI cabinet).", risk: "opt" },
      ],
    },
  },
};

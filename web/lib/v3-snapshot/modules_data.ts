...
export const V3_MODULES: V3Module[] = [
  ...
  },
  {
    ...
    benchmark: {
      texte: "Une optimisation logiciel bien ciblée représente 25 à 40 minutes gagnées par jour — soit 80 à 130 heures de travail récupérées sur l'année. C'est l'un des leviers à plus fort retour sur temps investi en cabinet.",

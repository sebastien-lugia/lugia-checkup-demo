...
export const V3_SIGNALS: V3Signal[] = [
  {
    ...
    bilanRisques: [
      ...
      { title: "Outils sous-mobilisés", desc: "Vos outils pourraient porter une partie du flux qui passe aujourd'hui par votre mémoire.", risk: "warn" },
    ],
    radarAnnotations: [
  ...
  },
  {
    ...
    bilanRisques: [
      ...
      { title: "Outils sous-exploités", desc: "Une part du quotidien passe par la mémoire alors qu'elle pourrait être tracée.", risk: "crit" },
  ...
  },
  {
    ...
    body: "Votre pratique de soin tient debout sans appui technologique fort — c'est une compétence rare. Les outils actuellement sous-exploités pourraient amplifier ce que vous faites déjà bien, sans changer votre façon d'exercer. Le levier est là.",
    phraseChocBefore:
      "Votre pratique tient sans appui technologique fort — compétence rare, mais —",
    phraseChocAfter:
      "des outils mieux exploités pourraient amplifier ce que vous faites déjà bien, sans changer votre exercice.",
    bilanForces: [

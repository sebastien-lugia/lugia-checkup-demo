...
/**
 * V3-snapshot — gestionnaire d'erreur Next.js pour la route /checkup/v3-snapshot (route gelée pré-charte).
 *
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div
          style={{
            background: "rgba(196,160,85,0.10)",
            border: "1px solid rgba(196,160,85,0.32)",

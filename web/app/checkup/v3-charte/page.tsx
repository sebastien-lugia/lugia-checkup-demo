...
import { type V3Step, nextStep, prevStep } from "@/lib/v3/state";
...
export default function CheckupV3BrandPage() {
  ...
  useEffect(() => {
    if (isLivrable && !prevIsLivrable.current) {
      // On vient d'entrer dans la zone livrable
      setTheme("day");
    }
        ...
        <ResultatsV3
          ...
          axisADetail={{
            ...
            marges: [
              ...
              { text: "Alerte automatique sur résultats hors normes.", risk: "opt" },
            ],
          }}
          ...
          axisBDetail={{
            ...
            marges: [
              ...
              { text: "Outiller la circulation d'information.", risk: "opt" },
            ],
          }}
          ...
          axisCDetail={{
            ...
            marges: [
              { text: "Étendre l'usage du logiciel (modèles, raccourcis).", risk: "opt" },
